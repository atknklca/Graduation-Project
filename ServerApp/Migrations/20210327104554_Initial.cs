        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    restaurantAdress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    restaurantGsm = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantDto", x => x.RestaurantID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    restaurantAdress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    restaurantGsm = table.Column<int>(type: "int", nullable: false),
                    restaurantPwd = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReservationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    reservationOwner = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    reservationOwnerGSM = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_RestaurantDto_RestaurantID1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavoritesFoodID = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodUserDto", x => new { x.FavoritesFoodID, x.UsersId });
                    table.ForeignKey(
                        name: "FK_FoodUserDto_Foods_FavoritesFoodID",
                        column: x => x.FavoritesFoodID,
                        principalTable: "Foods",
                        principalColumn: "FoodID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodUserDto_UserDto_UsersId",
                        column: x => x.UsersId,
                        principalTable: "UserDto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
